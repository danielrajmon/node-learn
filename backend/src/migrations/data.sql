...
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (25, 6, '1xx – Informational', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (26, 6, '2xx – Success', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (27, 6, '3xx – Redirection', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (28, 6, '4xx – Client Errors', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (29, 6, '5xx – Server Errors', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (30, 6, '4xx – Server Errors', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (31, 6, '5xx – Client Errors', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (32, 6, '2xx – SSL handshake completed', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (33, 6, '4xx – Firewall rejection', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (34, 6, '3xx – Load balancer routing', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (35, 6, '5xx – Fatal error', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (36, 7, 'CQRS separates writes (commands) and reads (queries) into different models so that changing data and reading data are handled independently.', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (37, 7, 'CQRS is an architecture that uses one database for writes and a different database for queries in order to increase performance.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (38, 7, 'CQRS is a design pattern where all state changes are stored as events instead of saving the current state.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (39, 7, 'CQRS is an architecture that requires message queues to process all write operations.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (40, 7, 'CQRS is a microservices-based architecture where one service handles writes and another handles reads.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (41, 7, 'CQRS is an approach where all commands are asynchronous and all queries are synchronous.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (42, 7, 'CQRS is a frontend architecture pattern that separates edit screens from view-only pages.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (43, 7, 'CQRS is simply CRUD with different names: queries are READ and commands are CREATE, UPDATE, DELETE.', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (44, 8, 'A J I H B C G F D E', true);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (45, 8, 'A J H I B C G F D E', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (46, 8, 'A J I H C B G F D E', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (47, 8, 'A J I H B C F G D E', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (48, 8, 'A J I H B C G F E D', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (49, 8, 'A I J H B C G F D E', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (50, 8, 'A J I H B C G D F E', false);
INSERT INTO public.choices (id, question_id, choice_text, is_good) VALUES (51, 8, 'A J H I C B F G D E', false);
...
SELECT pg_catalog.setval('public.choices_id_seq', 51, true);
